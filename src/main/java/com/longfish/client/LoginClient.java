...
public class LoginClient extends JFrame {
    ...
    private static final String facePath = RESOURCE_PATH + "face";
    private static final String defaultServerIp = DEFAULT_SERVER_ADDRESS;
    private static final int defaultServerPort = MAIN_SERVER_PORT;
