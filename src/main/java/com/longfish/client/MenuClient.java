...
public class MenuClient extends JFrame {
    ...
    private final int SERVER_PORT = MAIN_SERVER_PORT;
    ...
    public MenuClient() {
        this(DEFAULT_SERVER_ADDRESS, "", DEFAULT_AVATAR, false);
    }
    ...
    public MenuClient(String server, String name, String ava, boolean isAutoLogin) {
        ...
        joinButton.addActionListener(l -> {
            ...
            if (!userAvatars[index].equals(NONE) && !userAvatars[index + 1].equals(NONE)) {
    ...
    private void onMessage(String message) {
        ...
        if (message.contains("roomEntered:")) {
            ...
            if (userAvatars[firstIndex].equals(NONE)) {
                updateUserAvatar(firstIndex, avatar);
                userNames[firstIndex] = username;
            } else if (userAvatars[secondIndex].equals(NONE)) {
        ...
        if (message.contains("roomExited:")) {
            ...
            updateUserAvatar(index, NONE);
            updateUserAvatar(index + 1, NONE);
        }
    ...
    private void connectToServer() {
        try {
            ...
            if (!isClosing) JOptionPane.showMessageDialog(this, "服务器已离线！");
            backToLogin();
        }
    }
    ...
    public void updateUserAvatar(int avatarIndex, String face) {
        if (avatarIndex >= 0 && avatarIndex < 30) {
            ...
            String facePath;
            if (face.equals(NONE)) facePath = projectPath + "img\\noone.gif";
