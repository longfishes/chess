...
public class MainServer {
    ...
    private static final int port = MAIN_SERVER_PORT;
    ...
    private void onMessage(Socket clientSocket, String message) {
        ...
        if (message.contains("enterRoom:")) {
            ...
            if (userNames[index].equals(NONE)) {
            ...
            } else if (userNames[index + 1].equals(NONE)) {
        ...
        if (message.contains("restartRoom:")) {
            ...
            int index = (roomId - 1) * 2;
            userNames[index] = NONE;
            userNames[index + 1] = NONE;
            userAvatars[index] = NONE;
            userAvatars[index + 1] = NONE;
        }
    }
